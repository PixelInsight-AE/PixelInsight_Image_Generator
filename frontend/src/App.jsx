...
function GeneratedImageComponent({ nineGeneratedImages, setNineGeneratedImages }) {
  ...
  return (
    <>
      <header className="App-header">
        <img src="./src/assets/PixelInsightNoBackground.png"/>
        <p>"Insightful solutions for a pixel-perfect world"</p> 
      </header> 
      <main>
        <GeneratedImageComponent nineGeneratedImages={nineGeneratedImages} setNineGeneratedImages={setNineGeneratedImages} />
      </main>
      <footer>
...
function FooterLinks() {
  return (
    <>
      <p>© 2023 Pixel Insight A.E. - Image Generator <a href='https://github.com/PixelInsight-AE' target="_blank"><i className="fa-brands fa-square-github"></i></a></p>
    </>
  )
}
